...
notebooks/
  ...
  Julies_arbejdsfil.ipynb          # Not started
  ...
  Exploring_data.ipynb             # Stub / idea sketch — not used
...
docs/                              # GitHub Pages root — ONLY files here are served
  ...
  plots/
    global_spread.html             # Deployed Folium choropleth — embedded in Section 1
    total_infections_world.html    # Plotly infections trend
    total_deaths_world.html        # Plotly deaths trend
    fatality_rate_map.html         # Folium fatality rate choropleth
    dashboard.html                 # Combined cases/deaths/vaccination/stringency dashboard
    testing_chart.html             # Testing rates — DK/DE/UK comparison
    testing_map.html               # Global testing map
    testing_map_chart.html         # Combined testing map + chart
    testing_policy.html            # Testing policy timeline
    stay_at_home.html              # Stay-at-home requirements over time
    workplace_closing.html         # Workplace closure timeline
    school_closing.html            # School closure timeline
    public_transport_closing.html  # Public transport closure timeline
    facial_coverings.html          # Facial coverings policy
    vaccination_policy.html        # Vaccination policy timeline
    ...
    kats plots/                    # Kat's PNG and interactive HTML exports (35+ files)
      confirmed_cases.png          # 7-day avg new cases for DK/DE/UK — embedded in Section 2
      interactive_government_stringency_index_7day_avg.html
